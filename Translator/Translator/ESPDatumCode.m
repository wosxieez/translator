...
- (id) initWithSsid: (NSString *) apSsid andApBssid: (NSString *) apBssid andApPwd: (NSString*) apPwd andInetAddrData: (NSData *) ipAddrData andIsSsidHidden: (BOOL) isSsidHidden
{
    ...
    if (self)
    {
        ...
        //cocomark [apPwdBytesData getBytes:apPwdBytes];
        //cocomark [apSsidBytesData getBytes:apSsidBytes];
        ...
        //cocomark [apBssidData getBytes:apBssidBytes];
        ...
        //cocomark [ipAddrData getBytes:ipAddrUint8s];
